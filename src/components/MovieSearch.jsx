...
const MovieSearch = () => {
  ...
  return (
    <>
      <div className='flex fixed z-20 justify-center py-5 mx-auto mt-8 mb-3 w-full bg-gray-800 shadow-md shadow-violet-800'>
      ...
      <ul className='grid mt-16 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4'>
